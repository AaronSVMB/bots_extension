...
doc = """
Instructions and Comp Qs for Shared Endowment Treatment
"""


class C(BaseConstants):
    NAME_IN_URL = 'bots_shared_instrucs'
...
class QuestionFour(Page):
    ...
    def error_message(player: Player, values):
        if values['comprehension_question_four_a'] != 12:
            ...
            return 'Reconsider your answer to question four A: You invested 6 points to the Blue Group, ' \
        ...
        if values['comprehension_question_four_b'] != 21:
            ...
            return 'Reconsider your answer to question four B: You invested 11 points to your Green Group, ' \

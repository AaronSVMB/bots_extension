...
doc = """
Survey Questions for MULTI-group sessions of the BOTS extensions
"""


class C(BaseConstants):
    NAME_IN_URL = 'bots_multi_survey'
...
class Player(BasePlayer):
    ...
    bots_pattern_blue = models.IntegerField(
        choices=[
            [1, 'They tended to invest more in the group account followinga period in which the human subject(s) invested more.'],
            [2, 'They tended to invest less in the group account following a period in which the human subject(s) invested more.'],
            [3, "I don't think their investments were influenced by the investments of the human subject(s) in the previous period."]
        ],
        widget=widgets.RadioSelect,
    ...
    bots_understand_blue = models.IntegerField(
        choices=[
            [1, "Trying to understand the computerized subject(s)' investment decisions helped me increase my own earnings."],
            [2, "Trying to understand the computerized subject(s)' investment decisions did not help me increase my own earnings."],
            [3, "I really don't know whether trying to understand the computerized subject(s) investment decisions helped me increase my own earnings."]
        ],
        widget=widgets.RadioSelect,
...
class SurveyBots(Page):
    ...
    form_fields = ['bot_number_blue', 'bot_level_blue', 'bots_pattern_blue', 'bots_own_blue', 'bots_understand_blue',
                   'bot_number_green', 'bot_level_green', 'bots_pattern_green', 'bots_own_green', 'bots_understand_green']
